...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="bg-gray-800 p-6 rounded-lg shadow-lg max-w-md w-full mb-10"
      ...
      >
        ...
        <h2 className="text-2xl font-bold mb-2 text-white">Registration Closed</h2>
        <p className="text-gray-300">For details, contact us on Instagram</p>
